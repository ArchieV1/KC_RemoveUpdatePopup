...
SET "kac-mod-directory=D:\SteamLibrary\steamapps\common\Kingdoms and Castles\KingdomsAndCastles_Data\mods\KC_RemoveUpdatePopup"
SET "wip-mod-directory=C:\Users\green\RiderProjects\KC_RemoveUpdatePopup"
